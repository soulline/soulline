...
public final class StringUtil {
  ...
  static {
    ...
    escapeStrings.put("&nbsp;", Character.valueOf('\u00A0'));
    escapeStrings.put("&iexcl;", Character.valueOf('\u00A1'));
    escapeStrings.put("&cent;", Character.valueOf('\u00A2'));
    escapeStrings.put("&pound;", Character.valueOf('\u00A3'));
    escapeStrings.put("&curren;", Character.valueOf('\u00A4'));
    escapeStrings.put("&yen;", Character.valueOf('\u00A5'));
    escapeStrings.put("&brvbar;", Character.valueOf('\u00A6'));
    escapeStrings.put("&sect;", Character.valueOf('\u00A7'));
    escapeStrings.put("&uml;", Character.valueOf('\u00A8'));
    escapeStrings.put("&copy;", Character.valueOf('\u00A9'));
    escapeStrings.put("&ordf;", Character.valueOf('\u00AA'));
    escapeStrings.put("&laquo;", Character.valueOf('\u00AB'));
    escapeStrings.put("&not;", Character.valueOf('\u00AC'));
    escapeStrings.put("&shy;", Character.valueOf('\u00AD'));
    escapeStrings.put("&reg;", Character.valueOf('\u00AE'));
    escapeStrings.put("&macr;", Character.valueOf('\u00AF'));
    escapeStrings.put("&deg;", Character.valueOf('\u00B0'));
    escapeStrings.put("&plusmn;", Character.valueOf('\u00B1'));
    escapeStrings.put("&sup2;", Character.valueOf('\u00B2'));
    escapeStrings.put("&sup3;", Character.valueOf('\u00B3'));
    escapeStrings.put("&acute;", Character.valueOf('\u00B4'));
    escapeStrings.put("&micro;", Character.valueOf('\u00B5'));
    escapeStrings.put("&para;", Character.valueOf('\u00B6'));
    escapeStrings.put("&middot;", Character.valueOf('\u00B7'));
    escapeStrings.put("&cedil;", Character.valueOf('\u00B8'));
    escapeStrings.put("&sup1;", Character.valueOf('\u00B9'));
    escapeStrings.put("&ordm;", Character.valueOf('\u00BA'));
    escapeStrings.put("&raquo;", Character.valueOf('\u00BB'));
    escapeStrings.put("&frac14;", Character.valueOf('\u00BC'));
    escapeStrings.put("&frac12;", Character.valueOf('\u00BD'));
    escapeStrings.put("&frac34;", Character.valueOf('\u00BE'));
    escapeStrings.put("&iquest;", Character.valueOf('\u00BF'));
    escapeStrings.put("&Agrave;", Character.valueOf('\u00C0'));
    escapeStrings.put("&Aacute;", Character.valueOf('\u00C1'));
    escapeStrings.put("&Acirc;", Character.valueOf('\u00C2'));
    escapeStrings.put("&Atilde;", Character.valueOf('\u00C3'));
    escapeStrings.put("&Auml;", Character.valueOf('\u00C4'));
    escapeStrings.put("&Aring;", Character.valueOf('\u00C5'));
    escapeStrings.put("&AElig;", Character.valueOf('\u00C6'));
    escapeStrings.put("&Ccedil;", Character.valueOf('\u00C7'));
    escapeStrings.put("&Egrave;", Character.valueOf('\u00C8'));
    escapeStrings.put("&Eacute;", Character.valueOf('\u00C9'));
    escapeStrings.put("&Ecirc;", Character.valueOf('\u00CA'));
    escapeStrings.put("&Euml;", Character.valueOf('\u00CB'));
    escapeStrings.put("&Igrave;", Character.valueOf('\u00CC'));
    escapeStrings.put("&Iacute;", Character.valueOf('\u00CD'));
    escapeStrings.put("&Icirc;", Character.valueOf('\u00CE'));
    escapeStrings.put("&Iuml;", Character.valueOf('\u00CF'));
    escapeStrings.put("&ETH;", Character.valueOf('\u00D0'));
    escapeStrings.put("&Ntilde;", Character.valueOf('\u00D1'));
    escapeStrings.put("&Ograve;", Character.valueOf('\u00D2'));
    escapeStrings.put("&Oacute;", Character.valueOf('\u00D3'));
    escapeStrings.put("&Ocirc;", Character.valueOf('\u00D4'));
    escapeStrings.put("&Otilde;", Character.valueOf('\u00D5'));
    escapeStrings.put("&Ouml;", Character.valueOf('\u00D6'));
    escapeStrings.put("&times;", Character.valueOf('\u00D7'));
    escapeStrings.put("&Oslash;", Character.valueOf('\u00D8'));
    escapeStrings.put("&Ugrave;", Character.valueOf('\u00D9'));
    escapeStrings.put("&Uacute;", Character.valueOf('\u00DA'));
    escapeStrings.put("&Ucirc;", Character.valueOf('\u00DB'));
    escapeStrings.put("&Uuml;", Character.valueOf('\u00DC'));
    escapeStrings.put("&Yacute;", Character.valueOf('\u00DD'));
    escapeStrings.put("&THORN;", Character.valueOf('\u00DE'));
    escapeStrings.put("&szlig;", Character.valueOf('\u00DF'));
    escapeStrings.put("&agrave;", Character.valueOf('\u00E0'));
    escapeStrings.put("&aacute;", Character.valueOf('\u00E1'));
    escapeStrings.put("&acirc;", Character.valueOf('\u00E2'));
    escapeStrings.put("&atilde;", Character.valueOf('\u00E3'));
    ...
    escapeStrings.put("&otilde;", Character.valueOf('\u00F5'));
    escapeStrings.put("&ouml;", Character.valueOf('\u00F6'));
    escapeStrings.put("&divide;", Character.valueOf('\u00F7'));
    escapeStrings.put("&oslash;", Character.valueOf('\u00F8'));
    escapeStrings.put("&ugrave;", Character.valueOf('\u00F9'));
    escapeStrings.put("&uacute;", Character.valueOf('\u00FA'));
    escapeStrings.put("&ucirc;", Character.valueOf('\u00FB'));
    ...
    escapeStrings.put("&yacute;", Character.valueOf('\u00FD'));
    escapeStrings.put("&thorn;", Character.valueOf('\u00FE'));
    escapeStrings.put("&yuml;", Character.valueOf('\u00FF'));
    escapeStrings.put("&fnof;", Character.valueOf('\u0192'));
    escapeStrings.put("&Alpha;", Character.valueOf('\u0391'));
    escapeStrings.put("&Beta;", Character.valueOf('\u0392'));
    escapeStrings.put("&Gamma;", Character.valueOf('\u0393'));
    escapeStrings.put("&Delta;", Character.valueOf('\u0394'));
    escapeStrings.put("&Epsilon;", Character.valueOf('\u0395'));
    escapeStrings.put("&Zeta;", Character.valueOf('\u0396'));
    escapeStrings.put("&Eta;", Character.valueOf('\u0397'));
    escapeStrings.put("&Theta;", Character.valueOf('\u0398'));
    escapeStrings.put("&Iota;", Character.valueOf('\u0399'));
    escapeStrings.put("&Kappa;", Character.valueOf('\u039A'));
    escapeStrings.put("&Lambda;", Character.valueOf('\u039B'));
    escapeStrings.put("&Mu;", Character.valueOf('\u039C'));
    escapeStrings.put("&Nu;", Character.valueOf('\u039D'));
    escapeStrings.put("&Xi;", Character.valueOf('\u039E'));
    escapeStrings.put("&Omicron;", Character.valueOf('\u039F'));
    escapeStrings.put("&Pi;", Character.valueOf('\u03A0'));
    escapeStrings.put("&Rho;", Character.valueOf('\u03A1'));
    escapeStrings.put("&Sigma;", Character.valueOf('\u03A3'));
    escapeStrings.put("&Tau;", Character.valueOf('\u03A4'));
    escapeStrings.put("&Upsilon;", Character.valueOf('\u03A5'));
    escapeStrings.put("&Phi;", Character.valueOf('\u03A6'));
    escapeStrings.put("&Chi;", Character.valueOf('\u03A7'));
    escapeStrings.put("&Psi;", Character.valueOf('\u03A8'));
    escapeStrings.put("&Omega;", Character.valueOf('\u03A9'));
    escapeStrings.put("&alpha;", Character.valueOf('\u03B1'));
    escapeStrings.put("&beta;", Character.valueOf('\u03B2'));
    escapeStrings.put("&gamma;", Character.valueOf('\u03B3'));
    escapeStrings.put("&delta;", Character.valueOf('\u03B4'));
    ...
    escapeStrings.put("&pi;", Character.valueOf('\u03C0'));
    escapeStrings.put("&rho;", Character.valueOf('\u03C1'));
    escapeStrings.put("&sigmaf;", Character.valueOf('\u03C2'));
    escapeStrings.put("&sigma;", Character.valueOf('\u03C3'));
    escapeStrings.put("&tau;", Character.valueOf('\u03C4'));
    escapeStrings.put("&upsilon;", Character.valueOf('\u03C5'));
    escapeStrings.put("&phi;", Character.valueOf('\u03C6'));
    ...
    escapeStrings.put("&psi;", Character.valueOf('\u03C8'));
    escapeStrings.put("&omega;", Character.valueOf('\u03C9'));
    escapeStrings.put("&thetasym;", Character.valueOf('\u03D1'));
    escapeStrings.put("&upsih;", Character.valueOf('\u03D2'));
    escapeStrings.put("&piv;", Character.valueOf('\u03D6'));
    escapeStrings.put("&bull;", Character.valueOf('\u2022'));
    escapeStrings.put("&hellip;", Character.valueOf('\u2026'));
    escapeStrings.put("&prime;", Character.valueOf('\u2032'));
    escapeStrings.put("&Prime;", Character.valueOf('\u2033'));
    escapeStrings.put("&oline;", Character.valueOf('\u203E'));
    escapeStrings.put("&frasl;", Character.valueOf('\u2044'));
    escapeStrings.put("&weierp;", Character.valueOf('\u2118'));
    escapeStrings.put("&image;", Character.valueOf('\u2111'));
    escapeStrings.put("&real;", Character.valueOf('\u211C'));
    escapeStrings.put("&trade;", Character.valueOf('\u2122'));
    escapeStrings.put("&alefsym;", Character.valueOf('\u2135'));
    escapeStrings.put("&larr;", Character.valueOf('\u2190'));
    escapeStrings.put("&uarr;", Character.valueOf('\u2191'));
    escapeStrings.put("&rarr;", Character.valueOf('\u2192'));
    escapeStrings.put("&darr;", Character.valueOf('\u2193'));
    escapeStrings.put("&harr;", Character.valueOf('\u2194'));
    escapeStrings.put("&crarr;", Character.valueOf('\u21B5'));
    escapeStrings.put("&lArr;", Character.valueOf('\u21D0'));
    escapeStrings.put("&uArr;", Character.valueOf('\u21D1'));
    escapeStrings.put("&rArr;", Character.valueOf('\u21D2'));
    escapeStrings.put("&dArr;", Character.valueOf('\u21D3'));
    escapeStrings.put("&hArr;", Character.valueOf('\u21D4'));
    escapeStrings.put("&forall;", Character.valueOf('\u2200'));
    escapeStrings.put("&part;", Character.valueOf('\u2202'));
    escapeStrings.put("&exist;", Character.valueOf('\u2203'));
    escapeStrings.put("&empty;", Character.valueOf('\u2205'));
    escapeStrings.put("&nabla;", Character.valueOf('\u2207'));
    escapeStrings.put("&isin;", Character.valueOf('\u2208'));
    escapeStrings.put("&notin;", Character.valueOf('\u2209'));
    escapeStrings.put("&ni;", Character.valueOf('\u220B'));
    escapeStrings.put("&prod;", Character.valueOf('\u220F'));
    escapeStrings.put("&sum;", Character.valueOf('\u2211'));
    escapeStrings.put("&minus;", Character.valueOf('\u2212'));
    escapeStrings.put("&lowast;", Character.valueOf('\u2217'));
    escapeStrings.put("&radic;", Character.valueOf('\u221A'));
    escapeStrings.put("&prop;", Character.valueOf('\u221D'));
    escapeStrings.put("&infin;", Character.valueOf('\u221E'));
    escapeStrings.put("&ang;", Character.valueOf('\u2220'));
    escapeStrings.put("&and;", Character.valueOf('\u2227'));
    escapeStrings.put("&or;", Character.valueOf('\u2228'));
    escapeStrings.put("&cap;", Character.valueOf('\u2229'));
    escapeStrings.put("&cup;", Character.valueOf('\u222A'));
    escapeStrings.put("&int;", Character.valueOf('\u222B'));
    escapeStrings.put("&there4;", Character.valueOf('\u2234'));
    escapeStrings.put("&sim;", Character.valueOf('\u223C'));
    escapeStrings.put("&cong;", Character.valueOf('\u2245'));
    escapeStrings.put("&asymp;", Character.valueOf('\u2248'));
    escapeStrings.put("&ne;", Character.valueOf('\u2260'));
    escapeStrings.put("&equiv;", Character.valueOf('\u2261'));
    escapeStrings.put("&le;", Character.valueOf('\u2264'));
    escapeStrings.put("&ge;", Character.valueOf('\u2265'));
    escapeStrings.put("&sub;", Character.valueOf('\u2282'));
    escapeStrings.put("&sup;", Character.valueOf('\u2283'));
    escapeStrings.put("&nsub;", Character.valueOf('\u2284'));
    escapeStrings.put("&sube;", Character.valueOf('\u2286'));
    escapeStrings.put("&supe;", Character.valueOf('\u2287'));
    escapeStrings.put("&oplus;", Character.valueOf('\u2295'));
    escapeStrings.put("&otimes;", Character.valueOf('\u2297'));
    escapeStrings.put("&perp;", Character.valueOf('\u22A5'));
    escapeStrings.put("&sdot;", Character.valueOf('\u22C5'));
    escapeStrings.put("&lceil;", Character.valueOf('\u2308'));
    escapeStrings.put("&rceil;", Character.valueOf('\u2309'));
    escapeStrings.put("&lfloor;", Character.valueOf('\u230A'));
    escapeStrings.put("&rfloor;", Character.valueOf('\u230B'));
    escapeStrings.put("&lang;", Character.valueOf('\u2329'));
    escapeStrings.put("&rang;", Character.valueOf('\u232A'));
    escapeStrings.put("&loz;", Character.valueOf('\u25CA'));
    escapeStrings.put("&spades;", Character.valueOf('\u2660'));
    escapeStrings.put("&clubs;", Character.valueOf('\u2663'));
    escapeStrings.put("&hearts;", Character.valueOf('\u2665'));
    escapeStrings.put("&diams;", Character.valueOf('\u2666'));
    escapeStrings.put("&quot;", Character.valueOf('\u0022'));
    escapeStrings.put("&amp;", Character.valueOf('\u0026'));
    escapeStrings.put("&lt;", Character.valueOf('\u003C'));
    escapeStrings.put("&gt;", Character.valueOf('\u003E'));
    escapeStrings.put("&OElig;", Character.valueOf('\u0152'));
    escapeStrings.put("&oelig;", Character.valueOf('\u0153'));
    escapeStrings.put("&Scaron;", Character.valueOf('\u0160'));
    escapeStrings.put("&scaron;", Character.valueOf('\u0161'));
    escapeStrings.put("&Yuml;", Character.valueOf('\u0178'));
    escapeStrings.put("&circ;", Character.valueOf('\u02C6'));
    escapeStrings.put("&tilde;", Character.valueOf('\u02DC'));
    escapeStrings.put("&ensp;", Character.valueOf('\u2002'));
    escapeStrings.put("&emsp;", Character.valueOf('\u2003'));
    escapeStrings.put("&thinsp;", Character.valueOf('\u2009'));
    escapeStrings.put("&zwnj;", Character.valueOf('\u200C'));
    escapeStrings.put("&zwj;", Character.valueOf('\u200D'));
    escapeStrings.put("&lrm;", Character.valueOf('\u200E'));
    escapeStrings.put("&rlm;", Character.valueOf('\u200F'));
    escapeStrings.put("&ndash;", Character.valueOf('\u2013'));
    escapeStrings.put("&mdash;", Character.valueOf('\u2014'));
    escapeStrings.put("&lsquo;", Character.valueOf('\u2018'));
    escapeStrings.put("&rsquo;", Character.valueOf('\u2019'));
    escapeStrings.put("&sbquo;", Character.valueOf('\u201A'));
    escapeStrings.put("&ldquo;", Character.valueOf('\u201C'));
    escapeStrings.put("&rdquo;", Character.valueOf('\u201D'));
    escapeStrings.put("&bdquo;", Character.valueOf('\u201E'));
    escapeStrings.put("&dagger;", Character.valueOf('\u2020'));
    escapeStrings.put("&Dagger;", Character.valueOf('\u2021'));
    escapeStrings.put("&permil;", Character.valueOf('\u2030'));
    escapeStrings.put("&lsaquo;", Character.valueOf('\u2039'));
    escapeStrings.put("&rsaquo;", Character.valueOf('\u203A'));
    escapeStrings.put("&euro;", Character.valueOf('\u20AC'));
  }
   ...
   */
	public static <V> Map lowercaseKeys(Map<String, V> map) {
		...
		for (Iterator<Entry<String, V>> it = map.entrySet().iterator(); it
				.hasNext();) {
