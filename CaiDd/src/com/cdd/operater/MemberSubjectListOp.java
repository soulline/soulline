...
public class MemberSubjectListOp extends BaseOperater {

	private ArrayList<SqAskItem> askList = new ArrayList<SqAskItem>();
	
	public MemberSubjectListOp(Context context) {
		super(context);
	}

	@Override
	public void initAction() {
		action = "forum/memberSubjectList.do";
	}

	public void setParams(String memberId, String pageNum) {
