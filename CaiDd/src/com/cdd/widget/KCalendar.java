...
public class KCalendar extends ViewFlipper implements
	...
	public static final int COLOR_BG_WEEK_TITLE = Color.parseColor("#4494c7"); // 星期标题背景颜色
	...
	private void drawFrame(LinearLayout oneCalendar) {
		...
		tb = res.getDimension(R.dimen.dd_dimen_20px);
		...
		for (int i = 0; i < ROWS_TOTAL; i++) {
			...
			for (int j = 0; j < COLS_TOTAL; j++) {
				...
				if (i == (ROWS_TOTAL - 1)) {
					col.setBackgroundResource(R.drawable.calendar_day_normal);
				} else {
