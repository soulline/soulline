...
public class RecordItemAdapter extends ArrayAdapter<PointItemRecord> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(context, R.layout.point_detail_item, null);
			holder.bianhao_value = (TextView) convertView.findViewById(R.id.bianhao_value);
			holder.co2_value = (TextView) convertView.findViewById(R.id.co2_value);
			holder.rh_value = (TextView) convertView.findViewById(R.id.rh_value);
			holder.t_value = (TextView) convertView.findViewById(R.id.t_value);
			holder.ssi_value = (TextView) convertView.findViewById(R.id.ssi_value);
			holder.mmi_value = (TextView) convertView.findViewById(R.id.mmi_value);
	...
	public class ViewHolder {
		public TextView bianhao_value, co2_value, rh_value, t_value, ssi_value, mmi_value;
	}
}
